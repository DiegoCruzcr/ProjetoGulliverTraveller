...
<body>
    ...
    <main>
        <h3 class="text-center display-6 lead my-5">Conheça a cultura Brasileira</h3>
        <article class="cultura row row-cols-3">
            <div class="col d-flex justify-content-center my-2">
                <div class="card text-center" style="width: 25rem;">
                    <img src="/assets/images/card-culinaria.webp" class="card-img-top" alt="Entreterimento">
                    <div class="card-body">
            ...
            <div class="col d-flex justify-content-center my-2">
                <div class="card text-center" style="width: 25rem;">
                    <img src="/assets/images/card-festas.webp" class="card-img-top" alt="Entreterimento">
                    <div class="card-body">
            ...
            <div class="col d-flex justify-content-center my-2">
                <div class="card text-center" style="width: 25rem;">
                    <img src="/assets/images/card-musica.jpg" class="card-img-top" alt="Entreterimento">
                    <div class="card-body">
            ...
            <div class="col d-flex justify-content-center my-2">
                <div class="card text-center" style="width: 25rem;">
                    <img src="/assets/images/card-indigena.jpeg" class="card-img-top" alt="Entreterimento">
                    <div class="card-body">
                        <h5 class="card-title">Influência indigena</h5>
                        <div class="d-flex justify-content-around align-items-center">
                            <div class="estrelas">
                                <i class="fa-solid fa-star"></i>
                                <i class="fa-solid fa-star"></i>
            ...
            <div class="col d-flex justify-content-center my-2">
                <div class="card text-center" style="width: 25rem;">
                    <img src="/assets/images/card-africana.webp" class="card-img-top" alt="Entreterimento">
                    <div class="card-body">
                        <h5 class="card-title">Influência africana</h5>
                        <div class="d-flex justify-content-around align-items-center">
                            <div class="estrelas">
                                <i class="fa-solid fa-star"></i>
                                <i class="fa-solid fa-star"></i>
            ...
            <div class="col d-flex justify-content-center my-2">
                <div class="card text-center" style="width: 25rem;">
                    <img src="/assets/images/card-europeia.webp" class="card-img-top" alt="Entreterimento">
                    <div class="card-body">
                        <h5 class="card-title">Influência europeia</h5>
                        <div class="d-flex justify-content-around align-items-center">
                            <div class="estrelas">
                                <i class="fa-solid fa-star"></i>
                                <i class="fa-solid fa-star"></i>
