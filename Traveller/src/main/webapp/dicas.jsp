    ...
    <main>
        <div class="container ">
            <div class="d-flex justify-content-center border-bottom">
                <h1 class="text-center display-3 lead my-5">Fique por dentro das melhores dicas:</h1>
            </div>
            <div class="row my-5">  
                <div class="col-lg-8 d-flex flex-column">
                    <a href="#" class="link-dark">
                        <h2 class="text-docs">Os melhores pontos atrativos da Avenida Paulista!</h2>
                    </a>
                    <p class="text-font">Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque, ducimus voluptates iste temporibus quaerat tempore rerum dolores 
                        laborum blanditiis laboriosam, 
                        cupiditate aliquam necessitatibus repellendus nemo numquam vitae dolor nobis eos.</p>
                </div>
                <div class="col-lg-4">
                    <img src="/assets/images/avenida_paulista.jpg" class="img-fluid" alt="image_description" srcset="">
                </div>
            </div>
            ...
            <div class="row my-5">
                <div class="col-lg-8 d-flex flex-column">
                    <a href="#" class="link-dark">
                        <h2 class="text-docs">Conheça os 10 melhores parques da cidade!</h2>
                    </a>
                    <p class="text-font">Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque, ducimus voluptates iste temporibus quaerat tempore rerum dolores 
                        laborum blanditiis laboriosam, 
                        cupiditate aliquam necessitatibus repellendus nemo numquam vitae dolor nobis eos.</p>
                ...
                <div class="col-lg-4">
                    <img src="/assets/images/card-parque.jpg" class="img-fluid" alt="image_description" srcset="">
                </div>
            </div>
            ...
            <div class="row my-5">
                <div class="col-lg-8 d-flex flex-column">
                    <a href="#" class="link-dark">
                        <h2 class="text-docs">Conheça as 10 melhores baladas indicadas pelos viajentes!</h2>
                    </a>
                    <p class="text-font">Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque, ducimus voluptates iste temporibus quaerat tempore rerum dolores 
                        laborum blanditiis laboriosam, 
                        cupiditate aliquam necessitatibus repellendus nemo numquam vitae dolor nobis eos.</p>
                ...
                <div class="col-lg-4">
                    <img src="/assets/images/card-balada.jpeg" class="img-fluid" alt="image_description" srcset="">
                </div>
            </div>
