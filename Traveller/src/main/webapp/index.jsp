...
<body>
    ...
    <main>
        ...
        <section class="intro">
            <h3 class="text-center my-5">Se você está buscando roteiros <br /> legais para o seu fim de semana, está no
                lugar
                certo!</h3>
            <div>
            ...
            <section class="row container-fluid">
                ...
                <div class="col col-lg-4 col-sm-12 ">
                    <div class="card nosso-card  mx-auto" style="width: 35rem;">
                        ...
                        <img src="/assets/icons/pegadas.svg" class="icone-card mx-auto" alt="...">
                        <div class="card-body">
                            <p class="card-text text-center">Some quick example text to build on the card title and make
                                up the bulk of the card's content.</p>
                        </div>
        ...
        <section>
            ...
            <section class="row container-fluid">
                <div class="col col-lg-4 col-sm-12">
                    <div class="card nosso-card  mx-auto" style="width: 35rem;">
                        <img src="/assets/images/avenida_paulista.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col col-lg-4">
                    <div class="card nosso-card  mx-auto" style="width: 35rem;">
                        <img src="/assets/images/porto_seguro.png" class="card-img-top" alt="...">
                        <div class="card-body">
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk
                                of the card's content.</p>
                        </div>
                ...
                <div class="col col-lg-4 col-sm-12">
                    <div class="card nosso-card  mx-auto" style="width: 35rem;">
                        <img src="/assets/images/porto_de_galinhas.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk
                                of the card's content.</p>
                        </div>
