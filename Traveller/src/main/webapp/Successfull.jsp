  ...
  <main>
    <section class="user row">
      <div class="foto-perfil col-4">
        <div class="foto">
          <img src="/icons/user_logo.svg" alt="�cone de usu�rio">
      ...
      <div class="box-icones col-8">
        <div class="icones">
          <img src="/icons/notification.svg" alt="�cone de notifica��o">
          <img src="/icons/chat.svg" alt="�cone de chat">
          <img src="/icons/estrela.svg" alt="�cone de notifica��o">
