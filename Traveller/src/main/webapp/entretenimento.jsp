...
<body>
    ...
    <main>
        <h3 class="text-center display-6 lead my-5">Encontre o melhor entretenimento parea você</h3>
        <article class="entretenimento row row-cols-3">
            <div class="col d-flex justify-content-center my-2">
                <div class="card text-center" style="width: 25rem;">
                    <img src="/assets/images/card-pesca.png" class="card-img-top" alt="Entreterimento">
                    <div class="card-body">
            ...
            <div class="col d-flex justify-content-center my-2">
                <div class="card text-center" style="width: 25rem;">
                    <img src="/assets/images/card-teatro.jpg" class="card-img-top" alt="Entreterimento">
                    <div class="card-body">
            ...
            <div class="col d-flex justify-content-center my-2">
                <div class="card text-center" style="width: 25rem;">
                    <img src="/assets/images/card-musical.webp" class="card-img-top" alt="Entreterimento">
                    <div class="card-body">
            ...
            <div class="col d-flex justify-content-center my-2">
                <div class="card text-center" style="width: 25rem;">
                    <img src="/assets/images/card-cinema.jpg" class="card-img-top" alt="Entreterimento">
                    <div class="card-body">
            ...
            <div class="col d-flex justify-content-center my-2">
                <div class="card text-center" style="width: 25rem;">
                    <img src="/assets/images/card-museu.jpg" class="card-img-top" alt="Entreterimento">
                    <div class="card-body">
                        <h5 class="card-title">Museu</h5>
                        <div class="d-flex justify-content-around align-items-center">
                            <div class="estrelas">
                                <i class="fa-solid fa-star"></i>
                                <i class="fa-solid fa-star"></i>
            ...
            <div class="col d-flex justify-content-center my-2">
                <div class="card text-center" style="width: 25rem;">
                    <img src="/assets/images/card-opera.jpg" class="card-img-top" alt="Entreterimento">
                    <div class="card-body">
                        <h5 class="card-title">Ópera</h5>
                        <div class="d-flex justify-content-around align-items-center">
                            <div class="estrelas">
                                <i class="fa-solid fa-star"></i>
                                <i class="fa-solid fa-star"></i>
