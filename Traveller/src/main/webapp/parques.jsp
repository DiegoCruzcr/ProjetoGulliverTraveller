...
<body>
    ...
    <main>
        <h3 class="text-center display-6 lead my-5">Conheça os parques mais visitados</h3>
        <article class="parques row row-cols-4">
            <div class="col d-flex justify-content-center my-2">
                <div class="card text-center" style="width: 25rem;">
                    <img src="/assets/images/card-ibirapuera.webp" class="card-img-top" alt="Hospedagem">
                    <div class="card-body">
            ...
            <div class="col d-flex justify-content-center my-2">
                <div class="card text-center" style="width: 25rem;">
                    <img src="/assets/images/card-lobos.webp" class="card-img-top" alt="Hospedagem">
                    <div class="card-body">
            ...
            <div class="col d-flex justify-content-center my-2">
                <div class="card text-center" style="width: 25rem;">
                    <img src="/assets/images/card-botanico.jpg" class="card-img-top" alt="Hospedagem">
                    <div class="card-body">
            ...
            <div class="col d-flex justify-content-center my-2">
                <div class="card text-center" style="width: 25rem;">
                    <img src="/assets/images/card-branca.jpg" class="card-img-top" alt="Hospedagem">
                    <div class="card-body">
            ...
            <div class="col d-flex justify-content-center my-2">
                <div class="card text-center" style="width: 25rem;">
                    <img src="/assets/images/card-burle.webp" class="card-img-top" alt="Hospedagem">
                    <div class="card-body">
            ...
            <div class="col d-flex justify-content-center my-2">
                <div class="card text-center" style="width: 25rem;">
                    <img src="/assets/images/card-tiete.webp" class="card-img-top" alt="Hospedagem">
                    <div class="card-body">
            ...
            <div class="col d-flex justify-content-center my-2">
                <div class="card text-center" style="width: 25rem;">
                    <img src="/assets/images/card-cantareira.webp" class="card-img-top" alt="Hospedagem">
                    <div class="card-body">
                        <h5 class="card-title">Parque Estadual da Cantareira</h5>
                        <div class="d-flex justify-content-around align-items-center">
                            <div class="estrelas">
                                <i class="fa-solid fa-star"></i>
                                <i class="fa-solid fa-star"></i>
            ...
            <div class="col d-flex justify-content-center my-2">
                <div class="card text-center" style="width: 25rem;">
                    <img src="/assets/images/card-independencia.webp" class="card-img-top" alt="Hospedagem">
                    <div class="card-body">
