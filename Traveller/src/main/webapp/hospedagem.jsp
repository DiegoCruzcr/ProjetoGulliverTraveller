...
<body>
    ...
    <main>
        <p class="text-center display-6 lead my-5">Descubra o melhor local para se hospedar<br />durante a sua viagem</p>
        <div class="container">
            <h4>São Paulo</h4>
            <div class="hoteis">
                <div class="card" style="width: 25rem;">
                    <img src="/assets/images/card-melia.jpg" class="card-img-top img-card" alt="...">
                    <div class="card-body">
                        <h5 class="card-title text-center">Meliá Ibirapuera</h5>
                        <div class="d-flex justify-content-around align-items-center">
                            ...
                            <a href="como_chegar.html" class="btn btn-primary">Conhecer</a>
                        </div>
                    </div>
                </div>

                <div class="card rounded" style="width: 25rem;">
                    <img src="/assets/images/card-transamerica.jpg" class="card-img-top img-card" alt="...">
                    <div class="card-body">
                        <h5 class="card-title text-center">Transamerica Executive Paulista</h5>
                        <div class="d-flex justify-content-around align-items-center">
                            <div class="estrelas">
                                <i class="fa-solid fa-star"></i>
                                <i class="fa-solid fa-star"></i>
                ...
                <div class="card rounded" style="width: 25rem;">
                    <img src="/assets/images/card-tivoli.jpg" class="card-img-top img-card" alt="...">
                    <div class="card-body">
                        <h5 class="card-title text-center">Tivoli Mofarrej São Paulo Hotel</h5>
                        <div class="d-flex justify-content-around align-items-center">
                            <div class="estrelas">
                                <i class="fa-solid fa-star"></i>
                                <i class="fa-solid fa-star"></i>
            ...
            <h4 class="mt-5">Rio de Janeiro</h4>
            <div class="hoteis">
                <div class="card rounded" style="width: 25rem;">
                    <img src="/assets/images/card-atlantico.jpg" class="card-img-top img-card" alt="...">
                    <div class="card-body">
                        <h5 class="card-title text-center">Hotel Atlântico Tower</h5>
                        <div class="d-flex justify-content-around align-items-center">
                            <div class="estrelas">
                                <i class="fa-solid fa-star"></i>
                                <i class="fa-solid fa-star"></i>
                ...
                <div class="card rounded" style="width: 25rem;">
                    <img src="/assets/images/card-orla.jpg" class="card-img-top img-card" alt="...">
                    <div class="card-body">
                        <h5 class="card-title text-center">Orla Copacabana Hotel</h5>
                        <div class="d-flex justify-content-around align-items-center">
                            <div class="estrelas">
                                <i class="fa-solid fa-star"></i>
                                <i class="fa-solid fa-star"></i>
                ...
                <div class="card rounded" style="width: 25rem;">
                    <img src="/assets/images/card-praia.jpg" class="card-img-top img-card" alt="...">
                    <div class="card-body">
                        <h5 class="card-title text-center">Hotel Atlântico Praia</h5>
                        <div class="d-flex justify-content-around align-items-center">
                            <div class="estrelas">
                                <i class="fa-solid fa-star"></i>
                                <i class="fa-solid fa-star"></i>
            ...
            <h4 class="mt-5">Pernambuco</h4>
            <div class="hoteis">
                <div class="card rounded" style="width: 25rem;">
                    <img src="/assets/images/card-village.jpg" class="card-img-top img-card" alt="...">
                    <div class="card-body">
                        <h5 class="card-title text-center">Hotel Village Porto de Galinhas</h5>
                        <div class="d-flex justify-content-around align-items-center">
                            <div class="estrelas">
                                <i class="fa-solid fa-star"></i>
                                <i class="fa-solid fa-star"></i>
                ...
                <div class="card rounded" style="width: 25rem;">
                    <img src="/assets/images/card-amoras.jpg" class="card-img-top img-card" alt="...">
                    <div class="card-body">
                        <h5 class="card-title text-center">Hotel Amoaras</h5>
                        <div class="d-flex justify-content-around align-items-center">
                            <div class="estrelas">
                                <i class="fa-solid fa-star"></i>
                                <i class="fa-solid fa-star"></i>
                ...
                <div class="card rounded" style="width: 25rem;">
                    <img src="/assets/images/card-premium.jpg" class="card-img-top img-card" alt="...">
                    <div class="card-body">
                        <h5 class="card-title text-center">Hotel Village Premium</h5>
                        <div class="d-flex justify-content-around align-items-center">
                            <div class="estrelas">
                                <i class="fa-solid fa-star"></i>
                                <i class="fa-solid fa-star"></i>
