    ...
    <nav class="navbar navbar-expand-lg bg-azul-claro-degrade">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.html"><img class="header-logo"
                    src="../assets/assets/icons/traveller-logo.svg" alt="Traveller"></a>
  ...
  <main>
    <section class="user row">
      <div class="foto-perfil col-4">
        <div class="foto">
          <img src="/assets/icons/user_logo.svg" alt="ícone de usuário">
          <h4 class="my-1">Nome:
      ...
      <div class="box-icones col-8">
        <div class="icones">
          <img src="/assets/icons/notification.svg" alt="ícone de notificação">
          <img src="/assets/icons/chat.svg" alt="ícone de chat">
          <img src="/assets/icons/estrela.svg" alt="ícone de notificação">
